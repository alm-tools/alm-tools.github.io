...
### A project with the singular purpose of removing all barriers of entry into TypeScript. The best TypeScript experience should be a single npm install away.
